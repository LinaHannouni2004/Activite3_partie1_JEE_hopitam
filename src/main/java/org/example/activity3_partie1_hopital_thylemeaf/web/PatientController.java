package org.example.activity3_partie1_hopital_thylemeaf.web;
...
public class PatientController {
    ...
    public String index(Model model,
        ...
        Page<patient> pagepatients = patientRepository.findByNomContaining(kw,PageRequest.of(page,size));
...
if(bindingResult.hasErrors()){ return "formPatients";}
    ...
    public String editPatient(Model model, @RequestParam(name="id") Long id,String keyword , int page) {
        ...
        if(patient == null) { // Si le patient n'existe pas
